  ...
  build: {
    ...
    rollupOptions: {
      ...
      input: {
        ...
        "abc-bookmark": resolve(__dirname, "abc-bookmark/index.html"),
        ...
        "numbers-sounds-bookmark": resolve(__dirname, "numbers-sounds-bookmark/index.html"),
        instructions: resolve(__dirname, "instructions/index.html"),
        "instructions-task1": resolve(__dirname, "instructions-task1/index.html"),
      },
    },
  },
});
